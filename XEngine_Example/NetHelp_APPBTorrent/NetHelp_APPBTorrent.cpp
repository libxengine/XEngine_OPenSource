...
int BTorrent_Creator(LPCXSTR lpszFile)
{
	XNETHANDLE xhToken;
#ifdef _MSC_BUILD
	LPCXSTR lpszFileDir = _T("D:\\321");
#else
	LPCXSTR lpszFileDir = _T("./321");
#endif
...
int BTorrent_Download()
{
	XNETHANDLE xhToken;
#ifdef _MSC_BUILD
	LPCXSTR lpszBTFile = _T("D:\\123.torrent");
	LPCXSTR lpszFileDir = _T("D:\\321");
#else
	LPCXSTR lpszBTFile = _T("./123.torrent");
	LPCXSTR lpszFileDir = _T("./321");
#endif
...
{
#ifdef _MSC_BUILD
	LPCXSTR lpszFile = _T("D:\\321.torrent");
#else
	LPCXSTR lpszFile = _T("./321.torrent");
#endif
