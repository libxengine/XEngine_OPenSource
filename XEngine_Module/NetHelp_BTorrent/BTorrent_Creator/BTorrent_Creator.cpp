...
bool CBTorrent_Creator::BTorrent_Creator_Init(XNETHANDLE* pxhToken, LPCXSTR lpszBTPath, int nPieceSize)
{
    ...
    if ((NULL == pxhToken) || (NULL == lpszBTPath))
    {
        ...
        BTDload_dwErrorCode = ERROR_XENGINE_DOWNLOAD_BTORRENT_CREATOR_INIT_PARAMENT;
        return FALSE;
    }
	//申请空间
	...
	{
		BTDload_IsErrorOccur = TRUE;
		BTDload_dwErrorCode = ERROR_XENGINE_DOWNLOAD_BTORRENT_CREATOR_INIT_MALLOC;
		return FALSE;
	}
...
bool CBTorrent_Creator::BTorrent_Creator_AddNode(XNETHANDLE xhToken, LPCXSTR lpszAddr, int nIndex)
{
	...
	{
		BTDload_IsErrorOccur = TRUE;
		BTDload_dwErrorCode = ERROR_XENGINE_DOWNLOAD_BTORRENT_CREATOR_NODE_PARAMENT;
		return FALSE;
	}
	...
	{
		BTDload_IsErrorOccur = TRUE;
		BTDload_dwErrorCode = ERROR_XENGINE_DOWNLOAD_BTORRENT_CREATOR_NODE_NOTFOUND;
...
bool CBTorrent_Creator::BTorrent_Creator_AddTracker(XNETHANDLE xhToken, LPCXSTR lpszAddr, int nIndex)
{
	...
	{
		BTDload_IsErrorOccur = TRUE;
		BTDload_dwErrorCode = ERROR_XENGINE_DOWNLOAD_BTORRENT_CREATOR_TRACKER_PARAMENT;
		return FALSE;
	}
	st_Locker.lock_shared();
	unordered_map<XNETHANDLE, BTORRENT_CREATORINFO>::const_iterator stl_MapIterator = stl_MapBTCreator.find(xhToken);
	...
	{
		BTDload_IsErrorOccur = TRUE;
		BTDload_dwErrorCode = ERROR_XENGINE_DOWNLOAD_BTORRENT_CREATOR_TRACKER_NOTFOUND;
		st_Locker.unlock_shared();
		return FALSE;
	}
	BTORRENT_PARSEMAP st_BTInfo;
...
bool CBTorrent_Creator::BTorrent_Creator_AddSeeds(XNETHANDLE xhToken, LPCXSTR lpszAddr, bool bSingle)
{
	...
	{
		BTDload_IsErrorOccur = TRUE;
		BTDload_dwErrorCode = ERROR_XENGINE_DOWNLOAD_BTORRENT_CREATOR_SEEDS_PARAMENT;
		return FALSE;
	}
	st_Locker.lock_shared();
	unordered_map<XNETHANDLE, BTORRENT_CREATORINFO>::const_iterator stl_MapIterator = stl_MapBTCreator.find(xhToken);
	...
	{
		BTDload_IsErrorOccur = TRUE;
		BTDload_dwErrorCode = ERROR_XENGINE_DOWNLOAD_BTORRENT_CREATOR_SEEDS_NOTFOUND;
		st_Locker.unlock_shared();
		return FALSE;
	}
	BTORRENT_PARSEMAP st_BTInfo;
...
bool CBTorrent_Creator::BTorrent_Creator_SetInfo(XNETHANDLE xhToken, LPCXSTR lpszCreator, LPCXSTR lpszComment /* = NULL */, LPCXSTR lpszCertBuffer /* = NULL */)
{
	...
	{
		BTDload_IsErrorOccur = TRUE;
		BTDload_dwErrorCode = ERROR_XENGINE_DOWNLOAD_BTORRENT_CREATOR_INFO_PARAMENT;
		return FALSE;
	}
	st_Locker.lock_shared();
	...
	{
		BTDload_IsErrorOccur = TRUE;
		BTDload_dwErrorCode = ERROR_XENGINE_DOWNLOAD_BTORRENT_CREATOR_INFO_NOTFOUND;
		st_Locker.unlock_shared();
		return FALSE;
	}
...
bool CBTorrent_Creator::BTorrent_Creator_GetTorrent(XNETHANDLE xhToken, LPCXSTR lpszBTFile /* = NULL */, XCHAR* ptszMsgBuffer /* = NULL */, int* pInt_MsgLen /* = NULL */)
{
	...
	{
		BTDload_IsErrorOccur = TRUE;
		BTDload_dwErrorCode = ERROR_XENGINE_DOWNLOAD_BTORRENT_CREATOR_FILE_PARAMENT;
		return FALSE;
	}
	st_Locker.lock_shared();
	unordered_map<XNETHANDLE, BTORRENT_CREATORINFO>::iterator stl_MapIterator = stl_MapBTCreator.find(xhToken);
	...
	{
		BTDload_IsErrorOccur = TRUE;
		BTDload_dwErrorCode = ERROR_XENGINE_DOWNLOAD_BTORRENT_CREATOR_FILE_NOTFOUND;
		st_Locker.unlock_shared();
		return FALSE;
	}
	...
	{
		BTDload_IsErrorOccur = TRUE;
		BTDload_dwErrorCode = ERROR_XENGINE_DOWNLOAD_BTORRENT_CREATOR_FILE_PARSE;
		return FALSE;
	}
	...
	if (NULL != lpszBTFile)
	{
		...
		{
			BTDload_IsErrorOccur = TRUE;
			BTDload_dwErrorCode = ERROR_XENGINE_DOWNLOAD_BTORRENT_CREATOR_FILE_FAILED;
			st_Locker.unlock_shared();
			return FALSE;
		}
