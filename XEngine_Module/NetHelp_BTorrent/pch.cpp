...
//    History:
*********************************************************************/
XBOOL BTDload_IsErrorOccur = FALSE;
...
/*                          BT下载器导出函数                            */
/************************************************************************/
extern "C" XBOOL BTorrent_DLoader_Create(XNETHANDLE * pxhToken, LPCXSTR lpszAddr, LPCXSTR lpszSavePath, LPCXSTR lpszTempFile)
{
...
extern "C" XBOOL BTorrent_DLoader_UPNPEnable(XNETHANDLE xhToken, XBOOL bEnable)
{
...
extern "C" XBOOL BTorrent_Parse_GetInfo(XNETHANDLE xhToken, XCHAR * ptszHash, XCHAR * ptszCreator, XCHAR * ptszComment)
{
...
/*                          BT种子制作导出函数                          */
/************************************************************************/
extern "C" XBOOL BTorrent_Creator_Init(XNETHANDLE * pxhToken, LPCXSTR lpszBTPath, int nPieceSize)
{
...
extern "C" XBOOL BTorrent_Creator_AddTracker(XNETHANDLE xhToken, LPCXSTR lpszAddr, int nIndex)
{
	return m_BTCreator.BTorrent_Creator_AddTracker(xhToken, lpszAddr, nIndex);
}
extern "C" XBOOL BTorrent_Creator_AddSeeds(XNETHANDLE xhToken, LPCXSTR lpszAddr, XBOOL bSingle)
{
	return m_BTCreator.BTorrent_Creator_AddSeeds(xhToken, lpszAddr, bSingle);
}
extern "C" XBOOL BTorrent_Creator_SetInfo(XNETHANDLE xhToken, LPCXSTR lpszCreator, LPCXSTR lpszComment, LPCXSTR lpszCertBuffer)
{
	return m_BTCreator.BTorrent_Creator_SetInfo(xhToken, lpszCreator, lpszComment, lpszCertBuffer);
}
extern "C" XBOOL BTorrent_Creator_GetTorrent(XNETHANDLE xhToken, LPCXSTR lpszBTFile, XCHAR * ptszMsgBuffer, int* pInt_MsgLen)
{
