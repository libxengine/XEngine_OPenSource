...
/*                         AI视觉图像模型接口错误                       */
/************************************************************************/
#define ERROR_XENGINE_MODULE_AIAPI_VISION_PARAMENT 0x01D1001              //参数错误，无法继续
#define ERROR_XENGINE_MODULE_AIAPI_VISION_MALLOC 0x01D1002                //申请内存失败
#define ERROR_XENGINE_MODULE_AIAPI_VISION_NOTFOUND 0x01D1003              //没有找到
#define ERROR_XENGINE_MODULE_AIAPI_VISION_PARSE 0x01D1004                 //JSON解析错误
#define ERROR_XENGINE_MODULE_AIAPI_VISION_FORMAT 0x01D1005                //JSON格式错误
/************************************************************************/
/*                         AI帮助接口错误                               */
/************************************************************************/
