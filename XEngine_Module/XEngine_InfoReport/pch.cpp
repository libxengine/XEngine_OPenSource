...
/*                        APIMachine报告                                */
/************************************************************************/
extern "C" bool InfoReport_APIMachine_Send(LPCXSTR lpszAPIUrl, LPCXSTR lpszServiceName, __int64x* pInt_TimeNumber)
{
	return m_APIMachine.InfoReport_APIMachine_Send(lpszAPIUrl, lpszServiceName, pInt_TimeNumber);
}
